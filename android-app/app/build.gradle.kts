...
android {
    namespace = "com.riverpermits.app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.riverpermits.app"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        release {
            ...
            // For release, use your actual server URL
...
dependencies {
    ...
    // Jetpack Compose - using explicit versions for compatibility
